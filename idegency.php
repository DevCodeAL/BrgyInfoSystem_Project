...
<body>
    ...
    <h4 style="text-align: center; padding: 10px;">Bararangay Idengency</h4>

    <div class="container mt-5">
    <h2>Upload File</h2>
    <form action="indegency_proccess.php" method="post" enctype="multipart/form-data">
        <div class="mb-3">
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '<td>' . '<a href="delete_pdf.php?delete_pdf=' . $row["id"] . '" class="btn btn-danger">Delete</a>' . '</td>';
        echo '</tr>';
    }
} else {
